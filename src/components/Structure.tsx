        ...
        <section className="py-20 relative bg-white dark:bg-surface-dark" id="structure">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                    <span className="text-accent-green font-semibold tracking-wider uppercase text-sm">Leadership</span>
                    <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mt-2">Badan Pengurus Harian</h2>
                </div>
                <div className="flex flex-col md:flex-row justify-center items-center gap-12 mb-16">
                    ...
                    <div className="text-center group">
                        <div className="relative w-48 h-48 mx-auto mb-6">
                            ...
                            <div className="absolute inset-2 rounded-full overflow-hidden shadow-xl border-4 border-white dark:border-gray-800">
                                <img alt="Portrait of Mutiara Annastasya Vice Chairperson" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAam3KOz0WB9drYfXaDsdor_FYLt3sTvTw9xbdhGeK8r95PTw6cZ9CWyckpa1aXUAGLTVMxN-pxJknsUBm_tf-XJc9no1nmb3-DwiDNFgnCD6mk2IflORd1OycICv-Alqf3763I1QB2XPs2T4C17a3f82iDgDyU4qnkS09n8OhoaYj3LzMVg4r91_DadErDwwyGfJDbL57RiQfpfbmARPUBP9pjxwOSpQ8fAv69XLPd6nGrlnl5gJ6XvJI-euSIjJEpRkn8MbrJnfgP" />
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-2xl mx-auto">
                    ...
                    <div className="glass-card p-6 rounded-xl flex items-center gap-4 hover:shadow-lg transition-shadow border-l-4 border-l-primary">
                        <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0 border-2 border-primary/30">
                            <img alt="Portrait of Rizqa Aulia Treasurer" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD0KJg-rVSTBY8FZ1zMt-y4J8a955lWhF8LnzhTR1AplOY6NmuPwTUggLUUhIIQzPIcXrRKQqhqsqayLDUiurO9xlTKwPVFbKMSrbxE15LJfgboq80WxvAR26WWwqCm6DkhnHKW9cL-85OU3hbiCno9LmgbiTXaFt2jkdstumVI230NBX9R_M4BUjygtvZKLkvrnQL-8wL3almG3wbd-kB0nW3maTXgBO0tiVw-iV2XaVV4SH5P1g1Oop284SkSWkAhHcfWdcbe-apF" />
                        </div>
                        <div>
